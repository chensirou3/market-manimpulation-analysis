"""
ETH Full Dataset Backtest (2017-2024)

Test asymmetric strategy on all timeframes with full 7-year dataset.
"""
...
print("=" * 80)
print("ETH Full Dataset Backtest - All Timeframes (2017-2024)")
print("=" * 80)
...
def run_backtest_for_timeframe(timeframe, use_sl_tp=False):
    ...
    # Load bars
    bars_path = f'results/bars_{timeframe}_eth_full_with_manipscore.csv'
...
output_path = 'results/eth_full_timeframes_comparison.csv'
