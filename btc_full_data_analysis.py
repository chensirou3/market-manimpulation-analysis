"""
BTC Complete Analysis - Process Full Dataset (2017-2025) in Yearly Batches

This script processes BTC data year by year to avoid memory issues,
...
print("=" * 80)
print("BTC Full Dataset Analysis (2017-2025) - Yearly Batch Processing")
print("=" * 80)
...
# Save 5min bars
output_path = 'results/bars_5min_btc_full_with_manipscore.csv'
...
for tf_name, tf_code in timeframes.items():
    ...
    # Save
    output_path = f'results/bars_{tf_name}_btc_full_with_manipscore.csv'
    bars.to_csv(output_path)
    print(f"Saved: {output_path}")

print("\n" + "=" * 80)
print("BTC Full Dataset Processing Complete!")
print("=" * 80)
print("\nGenerated files:")
print("  - results/bars_5min_btc_full_with_manipscore.csv")
print("  - results/bars_15min_btc_full_with_manipscore.csv")
print("  - results/bars_30min_btc_full_with_manipscore.csv")
print("  - results/bars_60min_btc_full_with_manipscore.csv")
print("  - results/bars_4h_btc_full_with_manipscore.csv")
print("  - results/bars_1d_btc_full_with_manipscore.csv")
